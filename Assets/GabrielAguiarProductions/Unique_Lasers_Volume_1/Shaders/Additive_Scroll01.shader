...
////// Emissive:
                ...
                float2 _DistortMainTexture_var = lerp( i.uv0, node_2493, _DistortMainTexture );
                float4 _MainTex = tex2D(_MainTexutre,TRANSFORM_TEX(_DistortMainTexture_var, _MainTexutre));
                ...
                float3 emissive = ((_DistortionMask_copy.rgb*_MainTex.rgb)*i.vertexColor.rgb*(_ColorMultiplier*_TintColor.rgb*_ColorRamp_var.rgb)*2.0*(_MainTex.a*pow(_Gradient_var.r,_GradientPower)*clamp(isFrontFace,0.2,1)));
